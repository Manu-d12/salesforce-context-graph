...
@Service
@AllArgsConstructor
public class PermissionSetDependenciesCollector {
    private final MetadataReaderService metadataReaderService;

    public List<GraphEdge> buildPermissionSetDependencies() {
//        List<String> permissionSetApiNames = metadataReaderService.listMetadataObjects("PermissionSet");
        List<String> permissionSetApiNames = new ArrayList<>();
        permissionSetApiNames.add("Archive_Data_View");
